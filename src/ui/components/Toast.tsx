    ...
    return (
      <div
        className={SubframeUtils.twClassNames(
          "group/2c7966c2 bg-default-background flex w-80 items-center gap-4 rounded-md px-4 py-3 shadow-lg",
          className,
        )}
        ref={ref}
        {...otherProps}
      >
        ...
        <div className="flex shrink-0 grow basis-0 flex-col items-start">
          {title ? (
            <span
              className={SubframeUtils.twClassNames(
                "text-body-bold font-body-bold text-default-font w-full",
                {
                  "text-success-700": variant === "success",
                  "text-error-700": variant === "error",
