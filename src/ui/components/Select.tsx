    ...
    >
      <div
        className={SubframeUtils.twClassNames(
          "group/969e345b data-[highlighted]:bg-brand-50 flex h-8 w-full cursor-pointer items-center gap-1 rounded-md px-3 hover:bg-neutral-100 active:bg-neutral-50",
          className,
        )}
        ref={ref}
      >
        ...
        <FeatherCheck className="text-body font-body text-default-font group-data-[state=checked]/969e345b:text-brand-600 hidden group-hover/969e345b:hidden group-data-[state=checked]/969e345b:inline-flex" />
      </div>
    </SubframeCore.Select.Item>
  );
});
...
>(function TriggerValue(
  ...
  return (
    <SubframeCore.Select.Value
      className={SubframeUtils.twClassNames(
        "text-body font-body text-default-font w-full whitespace-nowrap",
        className,
      )}
      ref={ref}
...
const Content = React.forwardRef<HTMLDivElement, ContentProps>(function Content(
  ...
  return children ? (
    <SubframeCore.Select.Content asChild={true} {...otherProps}>
      <div
        className={SubframeUtils.twClassNames(
          "border-neutral-border flex w-full flex-col items-start overflow-hidden rounded-md border border-solid bg-white px-1 py-1 shadow-lg",
          className,
        )}
        ref={ref}
      >
    ...
    return (
      ...
      >
        ...
        >
          ...
          <div
            className={SubframeUtils.twClassNames(
              "border-neutral-border bg-default-background group-focus-within/bb88f90b:border-brand-primary flex h-8 w-full flex-none flex-col items-start rounded-md border border-solid group-focus-within/bb88f90b:border group-focus-within/bb88f90b:border-solid",
              {
                "group-hover/bb88f90b:border-neutral-border border border-solid border-neutral-100 bg-neutral-100 group-hover/bb88f90b:border group-hover/bb88f90b:border-solid group-hover/bb88f90b:bg-neutral-100":
                  variant === "filled",
