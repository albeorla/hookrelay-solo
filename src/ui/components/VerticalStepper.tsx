  ...
  return (
    ...
    >
      ...
      >
        <div
          className={SubframeUtils.twClassNames(
            "bg-neutral-border flex h-2 w-0.5 flex-none flex-col items-center gap-2",
        ...
        >
          ...
          <FeatherCheck
            className={SubframeUtils.twClassNames(
              "text-heading-3 font-heading-3 text-default-font hidden",
              { "text-brand-700 inline-flex": variant === "completed" },
            )}
          />
        </div>
        <div
          className={SubframeUtils.twClassNames(
            "bg-neutral-border flex min-h-[8px] w-0.5 shrink-0 grow basis-0 flex-col items-center gap-2",
            { hidden: lastStep },
          )}
        />
      </div>
      ...
      >
        {label ? (
          <span
            className={SubframeUtils.twClassNames(
              "text-body font-body text-subtext-color line-clamp-2 w-full",
              {
