    ...
    <SubframeCore.Dialog.Content asChild={true} {...otherProps}>
      <div
        className={SubframeUtils.twClassNames(
          "border-neutral-border bg-default-background flex max-h-[90vh] min-w-[320px] flex-col items-start gap-2 overflow-auto rounded-md border border-solid shadow-lg",
          className,
        )}
        ref={ref}
      >
