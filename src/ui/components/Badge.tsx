    ...
    return (
      <div
        className={SubframeUtils.twClassNames(
          "group/97bdb082 border-brand-100 bg-brand-100 flex h-6 items-center gap-1 rounded-md border border-solid px-2",
          {
            "border-success-100 bg-success-100 border border-solid":
              variant === "success",
            "border-warning-100 bg-warning-100 border border-solid":
              variant === "warning",
            "border-error-100 bg-error-100 border border-solid":
              variant === "error",
      ...
      >
        ...
        {children ? (
          <span
            className={SubframeUtils.twClassNames(
              "text-caption font-caption text-brand-800 whitespace-nowrap",
              {
                "text-success-800": variant === "success",
                "text-warning-800": variant === "warning",
